...
<body>
	...
	<div id="main">
		...
		<div>
			...
			<s:if test='checkEmptyC=="true"'>
				<h3>カート情報はありません。</h3>
			</s:if>
			<s:elseif test="message == null">
				<h3>現在、カートの中身は以下のようになっております。</h3>
				<table border="1" id="mypage_table">
					...
					<s:iterator value="cartInfoDTOList">
						<tr>
							<td>
								<s:form action="CartDeleteSelectAction" method="execute">
									<input type="hidden" name="deleteId" value='<s:property value="id" />'>
									<s:submit value="削除" />		<!-- 変更済み -->
								</s:form>
							</td>
							<td>
								<div id="mypage_item_image_box">
				...
				<s:form action="GoCartSettleAction">
					<s:submit value="決済する" method="execute" />		<!-- 変更済み -->
				</s:form>
			</s:elseif>
