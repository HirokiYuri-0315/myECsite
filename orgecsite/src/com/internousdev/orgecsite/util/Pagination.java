package com.internousdev.orgecsite.util;
...
public class Pagination{
	...
	public PaginationDTO getPage(List<ItemDataDTO> productList, int pageSize, int pageNo){
		...
		// ページに表示する商品リストを準備。
		List<ItemDataDTO> currentProductInfoPage = new ArrayList<ItemDataDTO>();
...
//		int endI = paginationDTO.getEndRecordNo();
		...
		for(int i = startI; i < endI2; i++){
			...
			ItemDataDTO pInfoDTO = productList.get(i);
	...
	public PaginationDTO initialize(List<ItemDataDTO> productList, int pageSize){
